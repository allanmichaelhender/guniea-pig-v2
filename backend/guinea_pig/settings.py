...
CSRF_TRUSTED_ORIGINS = ["http://localhost", "http://127.0.0.1", "http://16.16.216.22", "http://13.49.100.49", "https://guinea-pig-portfolio.ddnsfree.com/"]
...
DATABASES = {
    "default": {
        ...
        "NAME": os.environ.get("POSTGRES_DB", "guinea_pig"),
